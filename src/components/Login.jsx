...
function Login() {
    ...
    async function submitHandler(e) {
        ...
        let correo = initSesion['mail'].value //correo@example.com
        let pwd = initSesion['pass'].value //contraseña
                            ...
                            <div className="mt-3">
                                <form action="" onSubmit={submitHandler} id='loginUser'>
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <input className="shadow appearance-none border border-gray-700 rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline bg-gray-700" type='email' required placeholder="correo@mail.com" id="mail" autoComplete="current-email"></input>
                                    </div>
                                    {/* Password */}
                                    <div className="mt-3">
                                        <label className="block text-slate-400 text-lg font-bold mb-1">Contraseña</label>
                                        <input className="shadow appearance-none border border-gray-700 rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline bg-gray-700" type='password' placeholder="********" id="pass" autoComplete="current-password"></input>
                                    </div>
                                    {/* btn Logueo */}
